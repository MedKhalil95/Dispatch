...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    location_search_label: "Search by name (finds the GPS position for you)",
    location_search_placeholder: "e.g. The Residence Tunis — then press Enter",
    location_search_button: "Search",
    location_search_searching: "Searching…",
    location_search_too_short: "Type at least 3 characters, then press Enter or Search.",
    location_search_wait: "One moment — please wait a second before searching again.",
    location_search_no_results: "No matches — try a different spelling, or drop a pin on the map instead.",
    location_search_failed: "Search failed — check your connection and try again.",
    cant_find_location: "Can't find the place you need? Search & add it",
  ...
  fr: {
    ...
    location_search_label: "Rechercher par nom (trouve la position GPS pour vous)",
    location_search_placeholder: "ex. The Residence Tunis — puis Entrée",
    location_search_button: "Rechercher",
    location_search_searching: "Recherche…",
    location_search_too_short: "Tapez au moins 3 caractères, puis appuyez sur Entrée ou Rechercher.",
    location_search_wait: "Un instant — patientez une seconde avant de relancer une recherche.",
    location_search_no_results: "Aucun résultat — essayez une autre orthographe, ou placez un repère sur la carte.",
    location_search_failed: "Échec de la recherche — vérifiez votre connexion et réessayez.",
    cant_find_location: "Vous ne trouvez pas le lieu ? Recherchez-le et ajoutez-le",
  ...
  ar: {
    ...
    location_search_label: "ابحث بالاسم (يحدد الموقع الجغرافي تلقائيًا)",
    location_search_placeholder: "مثال: ذا ريزيدنس تونس — ثم اضغط Enter",
    location_search_button: "بحث",
    location_search_searching: "جارٍ البحث…",
    location_search_too_short: "اكتب 3 أحرف على الأقل، ثم اضغط Enter أو زر البحث.",
    location_search_wait: "لحظة من فضلك — انتظر ثانية قبل إعادة البحث.",
    location_search_no_results: "لا توجد نتائج — جرّب كتابة الاسم بشكل مختلف، أو ضع علامة على الخريطة مباشرة.",
    location_search_failed: "تعذّر البحث — تحقق من الاتصال وحاول مجددًا.",
    cant_find_location: "لم تجد المكان المطلوب؟ ابحث عنه وأضفه",
